...
parser.add_argument('--gen_frm_dir', type=str, default='result2/CIKM_convgru_CHLA/')

parser.add_argument('--save_dir1', type=str, default='checkpoints/cikm_convgru_NFLA')
parser.add_argument('--gen_frm_dir1', type=str, default='result2/CIKM_convgru_NFLA/')

parser.add_argument('--save_dir2', type=str, default='checkpoints/cikm_convgru_PAR')
parser.add_argument('--gen_frm_dir2', type=str, default='result2/CIKM_convgru_PAR/')

parser.add_argument('--save_dir3', type=str, default='checkpoints/cikm_convgru_PLC')
parser.add_argument('--gen_frm_dir3', type=str, default='result2/CIKM_convgrup_PLC/')

parser.add_argument('--save_dir4', type=str, default='checkpoints/cikm_convgru_POC')
parser.add_argument('--gen_frm_dir4', type=str, default='result2/CIKM_convgru_POC/')

parser.add_argument('--save_dir5', type=str, default='checkpoints/cikm_convgru_SST')
parser.add_argument('--gen_frm_dir5', type=str, default='result2/CIKM_convgru_SST/')
